const Features = () => {
    return (
      <div className="my-20">
        <div className="dark:bg-gray-800 dark:text-gray-100 border border-green-200 rounded">
	<div className="px-4 py-16 mx-auto max-w-7xl sm:px-6 lg:px-8">
		<div className="max-w-3xl mx-auto text-center">
			<h2 className="text-3xl font-extrabold sm:text-4xl">The Features of Group Study</h2>
			<p className="mt-4 text-lg dark:text-gray-400 text-center">Embark on a journey of collaborative learning with our powerful group study features. Discover how our platform can transform your academic experience by enhancing engagement, comprehension, and productivity.</p>
		</div>
		<dl className="mt-12 space-y-10 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:gap-y-12 lg:grid-cols-4 lg:gap-x-8">
			...
			<div className="flex">
				...
				<div className="ml-3">
					<h2 className="text-base font-bold">Supportive Community</h2>
					<p className="mt-2 dark:text-gray-400">Join a warm and encouraging learning environment. Our Supportive Community connects you with peers, fostering collaboration and assistance.</p>
				</div>
			</div>
			<div className="flex">
				<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true" className="flex-shrink-0 w-6 h-6 dark:text-violet-400">
